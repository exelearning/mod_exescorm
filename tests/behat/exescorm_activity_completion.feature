@mod @mod_exescorm @core_completion @_file_upload @_switch_iframe
Feature: View activity completion in the EXESCORM activity
  In order to have visibility of exescorm completion requirements
  As a student
  I need to be able to view my exescorm completion progress
  ...
  Background:
    ...
    And the following "activity" exists:
      ...
      | packagefilepath          | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12-mini.zip |
  ...
  Scenario: View automatic completion items as a teacher
    Given I am on the "Music history" "exescorm activity" page logged in as teacher1
  ...
  Scenario: View automatic completion items as a student
    Given I am on the "Music history" "exescorm activity" page logged in as student1
    ...
    And I switch to "exescorm_object" iframe
    And I wait until the page is ready
    And I click on "[id='question_com.exescorm.golfsamples.interactions.playing_1_1']" "css_element"
    ...
    And I switch to "exescorm_object" iframe
    And I wait until the page is ready
    And I click on "[id='question_com.exescorm.golfsamples.interactions.fun_1_False']" "css_element"
    And I press "Submit Answers"
    ...
    And I wait until the page is ready
    And I switch to the main frame
    When I am on the "Music history" "exescorm activity" page
  ...
  Scenario: Use manual completion
    ...
    And I log out
    # Student view.
    When I am on the "Music history" "exescorm activity" page logged in as student1
