...
Feature: Scorm multi-sco review mode.
  ...
  Scenario: Test review mode with a single sco completion.
    When the following "activities" exist:
      ...
      | exescorm    | C1     | Basic Multi-sco EXESCORM package  | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12.zip      | 0               |
    ...
    And I should see "Basic Multi-sco EXESCORM package"
    And I am on the "Basic Multi-sco EXESCORM package" "exescorm activity" page
    And I should see "Enter"
    And I press "Enter"
  ...
  Scenario: Test review mode with all scos completed.
    When the following "activities" exist:
      | activity | course | name                           | packagefilepath                                               | forcenewattempt |
      | exescorm    | C1     | ADV Multi-sco EXESCORM package    | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12.zip      | 0               |
    ...
    And I follow "Exit activity"
    And I wait until the page is ready
    And I should see "ADV Multi-sco EXESCORM package"
    And I am on the "ADV Multi-sco EXESCORM package" "exescorm activity" page
    And I should see "Enter"
    And I press "Enter"
  ...
  Scenario: Test force completed set to Always.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt |
      | exescorm    | C1     | Basic Multi-sco EXESCORM package | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12-mini.zip | 2               |
    And I am on the "Basic Multi-sco EXESCORM package" "exescorm activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    And I switch to "exescorm_object" iframe
  ...
  Scenario: Test force completed set to when previous complete/passed/failed.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt |
      | exescorm    | C1     | Basic Multi-sco EXESCORM package | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12-mini.zip | 1               |
    And I am on the "Basic Multi-sco EXESCORM package" "exescorm activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    And I switch to "exescorm_object" iframe
  ...
  Scenario: Test force completed set to Always and student skipview
    When the following "activities" exist:
      ...
      | exescorm    | C1     | Basic Multi-sco EXESCORM package | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12-mini.zip | 2               | 2        |
    And I am on the "Basic Multi-sco EXESCORM package" "exescorm activity" page logged in as student1
    And I switch to "exescorm_object" iframe
    And I should see "Play of the game"
    And I switch to the main frame
  ...
  Scenario: Test force completed set to when previous complete/passed/failed.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt | skipview |
      | exescorm    | C1     | Basic Multi-sco EXESCORM package | mod/exescorm/tests/packages/RuntimeMinimumCalls_EXESCORM12-mini.zip | 1               | 2        |
    And I am on the "Basic Multi-sco EXESCORM package" "exescorm activity" page logged in as student1
    And I switch to "exescorm_object" iframe
    And I should see "Play of the game"
    And I switch to the main frame
