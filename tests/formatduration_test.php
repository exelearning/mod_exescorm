...
global $CFG;
require_once($CFG->dirroot . '/mod/exescorm/locallib.php'); // Include the code to test.

/**
 * Unit tests for exescorm_formatduration function from locallib.php
 *
...
class formatduration_test extends \basic_testcase {
    public function test_exescorm2004_format() {
        ...
        $suts = [1 => 'PT001H012M0043.12S', 2 => 'PT15.3S', 3 => 'P01Y02M5DT0H7M', 4 => 'P0Y0M0DT0H1M00.00S',
            5 => 'P1YT15M00.01S', 6 => 'P0Y0M0DT0H0M0.0S', 7 => 'P1MT4M0.30S', 8 => 'PT', 9 => 'P1DT2H3S', 10 => 'P4M'];
        $validates = [1 => "1 $strhours 12 $strminutes 43.12 $strseconds",
                            2 => "15.3 $strseconds",
        ...
        foreach ($suts as $key => $sut) {
            $formatted = exescorm_format_duration($sut);
            $this->assertEquals($formatted, $validates[$key]);
        }
    }

    public function test_exescorm12_format() {
        $stryears = get_string('years');
        $strmonths = trim(get_string('nummonths'));
        $strdays = get_string('days');
        $strhours = get_string('hours');
        ...
        $suts = [1 => '00:00:00', 2 => '1:2:3', 3 => '12:34:56.78', 4 => '00:12:00.03', 5 => '01:00:23', 6 => '00:12:34.00',
