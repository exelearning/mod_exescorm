...
$string['badexelearningpackage'] = 'O paquete non cumpre as normas dos contidos eXeLearning definidas para o sitio.';
...
$string['editdialogcontent'] = 'Está a piques de editar o contido en eXeLearning. Cando termine de editar, volverá automaticamente a Moodle.';
$string['editdialogcontent:caution'] = 'Se a actividade ten cualificacións ou intentos, poderían perderse ou provocar problemas de funcionamento se modifica a estrutura do contido ou as súas actividades interactivas.';
$string['editdialogcontent:continue'] = 'Desexa continuar?';
...
$string['erroraccessingreport'] = 'Erro accedendo ao informe';
...
$string['exeonline:provider_name_desc'] = 'Nome do provedor de eXeLearning. Utilízase para identificar o provedor na interface de eXeLearning.';
$string['exeonline:provider_version'] = 'Versión do provedor';
$string['exeonline:provider_version_desc'] = 'Versión do provedor de eXeLearning. Utilízase para identificar o provedor na interface de eXeLearning.';
...
$string['minimumscoregreater'] = 'A puntuación mínima debe ser maior que 0.';
...
$string['editorconfirmuninstall'] = 'Está seguro de que desexa eliminar o editor instalado pola administración? Utilizarase a versión incluída co plugin.';
...
$string['exescorm:manageembeddededitor'] = 'Xestionar a instalación do editor embebido de eXeLearning';
...
$string['stylesmanager_manage_hint'] = 'Abre a páxina de estilos para activar ou desactivar os estilos integrados, ou para eliminar estilos subidos.';
...
$string['stylesblockimport'] = 'Bloquear estilos importados pola persoa usuaria';
$string['stylesblockimport_desc'] = 'Cando está activado, o editor integrado oculta a pestana «Estilos de usuario» e rexeita instalar un estilo incluído nun proxecto .elpx importado. A persoa usuaria só poderá elixir da listaxe aprobada polo administrador. Equivale ao comportamento de eXeLearning ONLINE_THEMES_INSTALL=false.';
...
$string['stylesupload_goto_settings'] = 'Subir estilos desde a páxina de configuración do complemento';
...
$string['stylesupload_badentry'] = 'O arquivo ZIP contén entradas que non se poden ler.';
$string['stylesupload_unsafe'] = 'Entrada de arquivo non segura rexeitada: {$a}';
$string['stylesupload_multiconfig'] = 'O arquivo contén máis dun config.xml.';
$string['stylesupload_noconfig'] = 'Falta o config.xml no paquete de estilo.';
$string['stylesupload_mixedroots'] = 'O arquivo debe conter un único cartafol raíz ou ter todos os ficheiros na raíz.';
$string['stylesupload_badext'] = 'Tipo de ficheiro non permitido no paquete de estilo: {$a}';
$string['stylesupload_configread'] = 'Non se puido ler config.xml do arquivo.';
...
$string['stylesupload_traversal'] = 'Rexeitouse un intento de escalada de directorios durante a extracción.';
...
$string['stylesuploaded_hint'] = 'Activa ou desactiva os estilos subidos. Desmárcaos para ocultarlos do editor; elimínaos para borrarlos definitivamente.';
...
$string['stylesbuiltin_hint'] = 'Desmarca un estilo para ocultalo do editor. Os estilos integrados desactivados non se eliminan; o proxecto sempre pode recorrer ao estilo por defecto.';
