...
/**
 * Strings for component 'exescorm ', language 'en'
 *
...
$string['EXESCORM_AVERAGEATTEMPT'] = 'Average attempts';
...
$string['teachermodevisible'] = 'Reveal teacher content to teachers';
$string['teachermodevisible_help'] = 'eXeLearning packages can mark content as "teacher only", which the package hides by default. When this setting is enabled, teachers (users who can manage the activity) see that teacher content revealed in the activity; the plugin asks the package to show it via its supported URL parameter. Students never see teacher content regardless of this setting.';
...
$string['editdialogcontent'] = 'You are about to edit this package in eXeLearning. When you finish editing, you will return to Moodle automatically.';
$string['editdialogcontent:caution'] = 'If the activity has grades or attempts, they might be lost if you change the content structure or any interactive activity in eXeLearning.';
$string['editdialogcontent:continue'] = 'Continue?';
...
$string['exescormloggingon'] = 'API logging is on';
$string['exescormopen'] = 'Available from';
$string['exescormresponsedeleted'] = 'Deleted user attempts';
$string['exescorm:deleteownresponses'] = 'Delete own attempts';
$string['exescorm:savetrack'] = 'Save tracks';
...
$string['finishexescorm'] = 'If you have finished viewing this resource, {$a}';
$string['finishexescormlinkname'] = 'click here to return to the course page';
...
$string['masteryoverride_help'] = 'If enabled and a mastery score is provided, when LMSFinish is called and a raw score has been set, status will be recalculated using the raw score and mastery score and any status provided (including "incomplete") will be overridden.';
...
$string['player:prev'] = 'Previous';
$string['player:skipnext'] = 'Next within this level';
...
$string['privacy:metadata:aicc:data'] = 'Personal data passed through from the subsystem.';
...
$string['privacy:metadata:aicc_session:exescormmode'] = 'The mode of the element to be tracked';
$string['privacy:metadata:aicc_session:exescormstatus'] = 'The status of the element to be tracked';
...
$string['subplugintype_exescormreport'] = 'Report';
$string['subplugintype_exescormreport_plural'] = 'Reports';
...
$string['validateaexescorm'] = 'Validate a package';
...
$string['embeddedtypehelp'] = 'The activity will be created and you can then edit it using the embedded eXeLearning editor from the activity view page. You can optionally upload an .elpx project file to import existing content.';
...
$string['editorconfirmuninstall'] = 'Are you sure you want to remove the admin-installed editor? The bundled version will be used instead.';
...
$string['exescorm:manageembeddededitor'] = 'Manage the embedded eXeLearning editor installation';
