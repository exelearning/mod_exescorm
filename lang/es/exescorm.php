...
$string['editorconfirmuninstall'] = '¿Está seguro de que desea eliminar el editor instalado por administración? Se utilizará la versión incluida con el plugin.';
...
$string['exescorm:manageembeddededitor'] = 'Gestionar la instalación del editor embebido de eXeLearning';
