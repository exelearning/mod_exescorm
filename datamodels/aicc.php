...
$PAGE->requires->js_init_call('M.exescorm_api.init',
                                [$def, $cmiobj, $exescorm->auto, $CFG->wwwroot, $exescorm->id, $scoid,
                                    $attempt, $mode, $currentorg, sesskey(), $id, $exescorm->autocommit]
                            );
